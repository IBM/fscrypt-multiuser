...
CFLAGS=-fPIC -Wall -Werror -g -DDEBUG_BUILD $(EXTRA_CFLAGS)
LDFLAGS=-lcrypto $(EXTRA_LDFLAGS)

else ifeq ($(BUILD_TYPE), Release)
BUILD_DIR_WITH_TYPE=$(BUILD_DIR)/Release
CFLAGS=-fPIC -Wall -Werror $(EXTRA_CFLAGS)
LDFLAGS=-lcrypto $(EXTRA_LDFLAGS)
...
install:
	...
	install -Dm 664 fscrypt_pam_hook.h $(DESTDIR)$(INCLUDEDIR)/fscrypt_pam_hook.h
ifeq ($(DO_PAM_RULE_UPDATE), Y)
	install -Dm 664 fscrypt-multiuser-rule $(DESTDIR)$(PREFIX)/share/pam-configs/fscrypt-multiuser-rule
endif
...
$(BUILD_DIR_WITH_TYPE)/hash_my_password: $(addprefix $(BUILD_DIR_WITH_TYPE)/,hash_my_password.o hasher.o)
$(BUILD_DIR_WITH_TYPE)/wraptest: $(addprefix $(BUILD_DIR_WITH_TYPE)/,wraptest.o fscrypt_utils.o hasher.o)
$(BUILD_DIR_WITH_TYPE)/fscrypt_setup: $(addprefix $(BUILD_DIR_WITH_TYPE)/,fscrypt_setup.o fscrypt_utils.o hasher.o)
$(BUILD_DIR_WITH_TYPE)/pam_fscrypt_multiuser.so: $(addprefix $(BUILD_DIR_WITH_TYPE)/,pam_fscrypt_multiuser.o fscrypt_utils.o hasher.o)
$(BUILD_DIR_WITH_TYPE)/fscrypt_pam_example_hook.so: $(addprefix $(BUILD_DIR_WITH_TYPE)/,fscrypt_pam_example_hook.o)
